          ...
          <div id="metaboliteConcetration">
            ...
            <ResponsiveContainer width={300} height={300}>
              <LineChart width={300} height={300} data={this.state.dataModel} style={{ overflow: 'unset' }}>
                ...
                <Tooltip />
                <Line type="monotone" dataKey={this.state.concentrationsGlcDC} stroke="#8884d8" />
              </LineChart>
            </ResponsiveContainer>
          </div>
          <div>
            ...
            <div id="metaboliteOptions" className="options">
              <div className="buttonRow">
                <input name="concentrationsGlcDC" type="checkbox" onChange={this.click.bind(this)} checked={this.state.concentrationsGlcDCCheckbox} />
                <p>Glucose (GLC)</p>
              </div>
            </div>
          ...
          <div id="reactionVelocityProfiles">
            ...
            <ResponsiveContainer width={300} height={300}>
              <LineChart width={300} height={300} data={this.state.dataModel} style={{ overflow: 'unset' }}>
                ...
                <Tooltip />
                <Line yAxisId="1" type="monotone" dataKey={this.state.HEX1} stroke="#8884d8" />
                <Line yAxisId="2" type="monotone" dataKey={this.state.PYK} stroke="#82ca9d" />
              </LineChart>
            </ResponsiveContainer>
          </div>
          <div>
            ...
            <div className="buttonRow">
                <input name="HEX1" type="checkbox" onChange={this.click.bind(this)} checked={this.state.HEX1heckbox} />
                <p>Hexokinase (HEX)</p>
              </div>
              <div className="buttonRow">
                <input name="PYK" type="checkbox" onChange={this.click.bind(this)} checked={this.state.PYKCheckbox} />
                <p>Pyruvate kinase (PYK)</p>
              </div>
            </div>
            <h3 className="plotOptionsTitle">Plot Options</h3>
            <div className="plotOptions" />
